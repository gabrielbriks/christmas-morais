...
export function VideoPlayerConfirmation() {
  ...
  return (
    <div className="flex flex-col w-full h-full max-w-screen-lg items-center justify-between mt-20">
      <div className="flex flex-col min-w-full max-w-lg h-full gap-4 ">
        <p className="font-merriweather italic text-center w-full text-primary text-xl">
          Assista o vídeo & confirme sua presença
        </p>
        {showPlayer && (
          <>
            <MediaPlayer
